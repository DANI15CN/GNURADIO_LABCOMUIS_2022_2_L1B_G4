...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._fs_range = Range(100, 10000, 10, 2000, 200)
        self._fs_win = RangeWidget(self._fs_range, self.set_fs, "Frecuencia diente sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fs_win)
        self._fm_range = Range(100, 1000, 10, 200, 200)
        ...
        self._fc_range = Range(50000000, 1000000000, 1000000, 50000000, 200)
        ...
        self._A_range = Range(-3, 3, 0.1, 2, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, fs, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, fm, A, 0, 0)
        self.ModulosEfren_Compara_0 = ModulosEfren.Compara()
        self._DC_range = Range(-10, 10, 0.1, 0, 200)
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "Nivel de continua de la señal diente de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
    ...
    def set_fs(self, fs):
        self.fs = fs
        self.analog_sig_source_x_1.set_frequency(self.fs)
