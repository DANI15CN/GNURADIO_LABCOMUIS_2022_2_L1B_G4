...
class practica4_l1b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica4_l1b")
...
def main(top_block_cls=practica4_l1b, options=None):
