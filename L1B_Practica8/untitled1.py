...
from Envolvente_PM import Envolvente_PM  # grc-generated hier_block
...
class untitled1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "untitled1")
        ...
        self._fm_range = Range(1, 20000, 100, 1000, 200)
        ...
        self.Envolvente_PM_0 = Envolvente_PM(
            Ac=Ac,
            Kp=kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_PM_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_PM_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Envolvente_PM_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Envolvente_PM_0, 0))
    ...
    def set_kp(self, kp):
        self.kp = kp
        self.Envolvente_PM_0.set_Kp(self.kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Envolvente_PM_0.set_Ac(self.Ac)




def main(top_block_cls=untitled1, options=None):
