...
# Title: Muestreo_en_GNURADIO
# Author: Daniela_Cabrales_L1B_G4
...
class Practica_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Muestreo_en_GNURADIO", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Muestreo_en_GNURADIO")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Música/Practica2_L1B_Daniela/gitana_williecolon.wav-20221026T165316Z-001/gitana_williecolon.wav', True)
